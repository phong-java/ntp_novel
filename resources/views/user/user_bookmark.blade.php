    ...
    <div class="card-body">
        <div class="overflow-auto ntp_custom_ver_scrollbar" style="height: 150px;">
            <div class="d-flex flex-row my-1 align-items-center justify-content-between">
                ...
                <a href="{{route('Novel.show',[1])}}" class="btn btn-danger mx-2">X</a>
            </div>
            <div class="d-flex flex-row my-1 align-items-center justify-content-between">
            ...
            <div class="d-flex flex-row my-1 align-items-center justify-content-between">
                <a href="{{route('Novel.show',[1])}}" class="title text-truncate text-decoration-none text-reset"> Đồng Thời Xuyên

            ...
            <div class="card mb-4 mb-xl-0">
                ...
                <div class="card-body ntp_anh_bia_wrap text-center">
                    ...
                    <img class="ntp_anh_bia mb-2 w-100"
                        src="{{ asset('uploads/images/'.$novel->sCover)}}" alt="">
                ...
                <div class="card-body">
                    <form method="POST" id="ntp_form_create_novel" >
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="inputnovelname" maxlength="255" value="{{$novel->sNovel}}" name="tentruyen" type="text" placeholder="Tên truyện là">
                        </div>
                        <div class="mb-3">
                            <label class="small mb-1">Mô tả</label>
                            <textarea name="motatruyen" id="motatruyen" class="ntp_ckeditor ckeditor w-100" {{--cols="30" rows="10"--}}>{{$novel->sDes}}</textarea>
                        </div>
                        {{var_dump($theloai)}}

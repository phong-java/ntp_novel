<form method="POST" id="ntp_form_create_author" action="<?php echo $author_found == 0 ? route('Author.store') : route('Author.update', [$author->id]); ?>">
    ...
    <div class="row gx-3 mb-3">
        <div class="col-md-6">
            ...
            <div class="form-check">
                <input <?php echo ($author ? ($author->sBank == 'VCB' ? 'checked' : '') : '') ; ?> class="form-check-input" type="radio"
                    value="VCB" name="nganhang" id="nganhang1" required>
                <label class="form-check-label pe-auto" for="nganhang1">Vietcombank</label>
            </div>
            <div class="form-check">
                <input <?php echo ($author ? ($author->sBank == 'VTB' ? 'checked' : '') : '') ; ?> class="form-check-input" type="radio"
                    value="VTB" name="nganhang" id="nganhang2">
                <label class="form-check-label pe-auto" for="nganhang2">VietinBank </label>
            </div>
            <div class="form-check">
                <input <?php echo ($author ? ($author->sBank == 'TCB' ? 'checked' : '') : '') ; ?> class="form-check-input" type="radio"
                    value="TCB" name="nganhang" id="nganhang3">
                <label class="form-check-label pe-auto" for="nganhang3">Techcombank</label>
            </div>
            <div class="form-check">
                <input <?php echo ($author ? ($author->sBank == 'BIDV' ? 'checked' : '') : '') ; ?> class="form-check-input" type="radio"
            ...
            <div class="form-check">
                <input <?php echo ($author ? ($author->sBank == 'TPB' ? 'checked' : '') : '') ;?> class="form-check-input" type="radio"
                    value="TPB" name="nganhang" id="nganhang5">
                <label class="form-check-label pe-auto" for="nganhang5">TPBank</label>
            </div>
            <div class="form-check">
                <input <?php echo ($author ? ($author->sBank == 'AGB' ? 'checked' : '') : '') ; ?> class="form-check-input" type="radio"
    ...
    <div class="row gx-3 mb-3 <?php echo $author_found == 0 ? 'd-none' : ''; ?>">
        ...
        <iframe id="ntp_camket_da_upload" src="<?php echo $author_found == 0     ? '' : asset('uploads/camket/' . $author->sCommit); ?>"
